            <footer id=":rd:" class="width-wrapper bg-grey-blue">
                <div class="container flex-col">
                    <div class="top-footer">
                        <ul class="pages">
                            <li class="label"><a class="Sub animated-link" data-cursor="active" href="<?php echo get_url('about-us') ?>"><span class="title"><span data-text="<?php echo get_label('Про нас', 'About us') ?>" class="color-after-dark-blend-a color-before-white"><?php echo get_label('Про нас', 'About us') ?></span></span></a></li>
                            <li class="label"><a class="Sub animated-link" data-cursor="active" href="<?php echo get_url('products-services') ?>"><span class="title"><span data-text="<?php echo get_label('Продукти і послуги', 'Products & Services') ?>" class="color-after-dark-blend-a color-before-white"><?php echo get_label('Продукти і послуги', 'Products & Services') ?></span></span></a></li>
                            <li class="label"><a class="Sub animated-link" data-cursor="active" href="<?php echo get_url('career') ?>"><span class="title"><span data-text="<?php echo get_label('Вакансії', 'Career') ?>" class="color-after-dark-blend-a color-before-white"><?php echo get_label('Вакансії', 'Career') ?></span></span></a></li>
                            <li class="label"><a class="Sub animated-link" data-cursor="active" href="<?php echo get_url('contact-us') ?>"><span class="title"><span data-text="<?php echo get_label('Контакти', 'Contact Us') ?>" class="color-after-dark-blend-a color-before-white"><?php echo get_label('Контакти', 'Contact Us') ?></span></span></a></li>
                            <li class="label"><a class="Sub animated-link" data-cursor="active" href="<?php echo get_url('blog') ?>"><span class="title"><span data-text="<?php echo get_label('Блог', 'Blog') ?>" class="color-after-dark-blend-a color-before-white"><?php echo get_label('Блог', 'Blog') ?></span></span></a></li>
                            <li class="label"><a class="Sub animated-link" data-cursor="active" href="<?php echo get_url('charity') ?>"><span class="title"><span data-text="<?php echo get_label('Благодійність', 'Charity') ?>" class="color-after-dark-blend-a color-before-white"><?php echo get_label('Благодійність', 'Charity') ?></span></span></a></li>
                        </ul>
                        <ul class="contacts">
                            ...
                            <li class="label contact-title">
                                <p class="Sub color-white "></p>
                            </li>
                            <li class="link-label">
                                <p class="Body color-white "></p>
                            </li>
                        </ul>
                        <ul class="follow">
                            <li class="label">
                            ...
                            <li class="link-label" data-cursor="active"><a class="Body animated-link " href="https://www.linkedin.com/company/27443/admin/" target="_blank" rel="noopener noreferrer"><span class="title"><span data-text="LinkedIn" class="color-after-dark-blend-a color-before-white">LinkedIn</span></span></a></li>
                            <li class="link-label" data-cursor="active"><a class="Body animated-link " href="https://www.instagram.com/telesens_it/?hl=en" target="_blank" rel="noopener noreferrer"><span class="title"><span data-text="Instagram" class="color-after-dark-blend-a color-before-white">Instagram</span></span></a></li>
                            <li class="link-label" data-cursor="active"><a class="Body animated-link " href="https://twitter.com/Telesens_IT" target="_blank" rel="noopener noreferrer"><span class="title"><span data-text="Twitter" class="color-after-dark-blend-a color-before-white">Twitter</span></span></a></li>
                            <li class="link-label" data-cursor="active"><a class="Body animated-link " href="https://www.facebook.com/Telesens" target="_blank" rel="noopener noreferrer"><span class="title"><span data-text="Facebook" class="color-after-dark-blend-a color-before-white">Facebook</span></span></a></li>
                        </ul>
                    </div>
                    <div class="bottom-footer flex justify-between align-center">
                        <div data-cursor="active" onclick="goto('<?php echo pll_home_url() ?>')">
