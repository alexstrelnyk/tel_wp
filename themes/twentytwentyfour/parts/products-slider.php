                            ...
                            <div class="swiper-slide">
                                ...
                                <div class="product-card">
                                    ...
                                    <div class="product-title" style="width:60%; text-wrap:wrap;" data-cursor="slider-white">
                                        <p class="H2 color-white "><a class="mob-link color-white" href="<?php echo get_url('products-services') ?>?cat_slug=<?php echo $category->slug ?>"><?php echo $category->name ?></a></p>
                                    </div>
